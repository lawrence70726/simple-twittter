...
class twitter{
    ...
    int GetFollowerNum(int userid){    //w
        cnt = 0;
        for(int i=0;i<10;i++){
            if(following[i][userid]==1)
                cnt++;
    ...
    int GetFolloweeNum(int userid){    //w
        cnt = 0;
        for(int i=0;i<10;i++){
            if(following[userid][i]==1)
                cnt++;
        }
        return cnt;
    }
    ...
    void unfollow(int followerId, int followeeId) {
        ownFeed[followerId] = linkedlist.DeleteNode(ownFeed[followerId], followeeId);
        following[followerId][followeeId] = -1;
    }
    bool IfFollow(int userid,int followeeid){
        if(following[userid][followeeid]==1)
            return true;
        else
            return false;
    }
        ...
        while(1){
            ...
            switch(ch){
                ...
                case 'u':
                    ...
                    if(!tw.IfFollow(userid, unfollowid)){
                ...
                case 'p':
                    std::cout << "Username: " << userid << std::endl;
                    std::cout << tw.GetFolloweeNum(userid) << " Following    ";
                    std::cout << tw.GetFollowerNum(userid) << " Followers" << std::endl;
                    std::cout << "Personal posts: \n";
                    newsfeed = tw.getPersonalFeed(userid);
                    std::cout << "-----------------------------------\n";
                    for(int i=0;i<newsfeed.size();i++){
                        std::cout << newsfeed[i] << std::endl;
                        std::cout << "-----------------------------------\n";
